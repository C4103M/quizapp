...
// Exemplo de uso:
const xpUser = 92;
const progressoUser = calcularProgressoXP(xpUser);
console.log(
    `João está no nível ${progressoUser.nivel} com ${progressoUser.progresso}% da experiência necessária para o próximo nível.`
);
